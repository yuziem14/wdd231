...
function populateCourses(courses) {
  ...
  courses.forEach((course) => {
    ...
    const courseItemName = document.createElement("p");
    courseItemName.textContent = `${course.subject} ${course.number}`;
...
document
  .querySelectorAll(".course-menu button[data-filter-value]")
  .forEach((button) => {
    button.addEventListener("click", (e) =>
      filterCourses(button.getAttribute("data-filter-value"))
    );
  });
